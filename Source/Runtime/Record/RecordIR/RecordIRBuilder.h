...
class RecordIRBuilder
{
    ...
    public:
        ...
        inline NodeWrapper& SetInt(uint32_t value) {m_node->data.integerValue = value; return *this;}
...
public:
    ...
    inline const RecordObject& GetRecordObject() const { return m_recordObject;}
