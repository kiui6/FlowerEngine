...
public:
    ...
    Field<FList<FPair<FString, FList<FTrivial<uint16_t>>>>> m_actions{FIELDID(ACTS)};
    Field<FList<FPair<FString, FList<FPair<FTrivial<uint16_t>, FTrivial<float>>>>>> m_axis{FIELDID(AXIS)};
