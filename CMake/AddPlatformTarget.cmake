macro(setup_platform_target_apple)
target_link_libraries(${TARGET_NAME} PRIVATE MoltenVK)
        set_target_properties(${TARGET_NAME} PROPERTIES 
            MACOSX_BUNDLE TRUE
            MACOSX_BUNDLE_ICON_FILE "App.icns"
            MACOSX_BUNDLE_INFO_PLIST "${PROJECT_SOURCE_DIR}/Resources/Platforms/Mac/Info.plist.in"
            )
        ...
        add_custom_command(TARGET ${TARGET_NAME} POST_BUILD
            COMMAND ${CMAKE_COMMAND} -E copy
                "${PROJECT_SOURCE_DIR}/Resources/Platforms/Mac/editor.icns"
                "$<TARGET_BUNDLE_DIR:${TARGET_NAME}>/Contents/Resources/App.icns"
            COMMENT "Copying App.icns to app bundle"
        )
